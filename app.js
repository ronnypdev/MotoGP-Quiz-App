...
var state = {
  questions: [
    {
      text: "Who is the GOAT in MotoGP?",
      choices: ["Doohan", "Rossi", "Sonter", "Lorenzon"],
      correctChoiceIndex: 1
    },
    {
      text: "Who is the current MotoGP World Champion?",
      choices: ["Marquez", "Rossi", "Lorenzo", "Vinales"],
      correctChoiceIndex: 0
    },
    {
      text: "What is the name of Valnetino Rossi's Team ??",
      choices: ["Repsonl Honda", "Suzuki", "Movistar Yamaha", "Ducati"],
      correctChoiceIndex: 2,
    },
    {
      text: "What is Jorge Lorenzo's Number ?",
      choices: ["23", "46", "3", "99"],
      correctChoiceIndex: 3,
    },
    {
      text: "Who is going to be the 2017 World Champion?",
      choices: ["Rossi", "Vinales", "Lonrezo", "Marquez"],
      correctChoiceIndex: 0,
    }
  ],
  praises : [
